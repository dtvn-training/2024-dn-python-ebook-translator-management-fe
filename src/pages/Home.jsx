...
const Home = () => {
    ...
    const loadDashboard = async () => {
        try {
            const res_dashboard = await get('/task/dashboard');
            if (res_dashboard.status === 200) {
                setTaskData(res_dashboard.data);
            }
        } catch (error) {
            ...
            <div className="flex justify-around mt-8">
                <div className="bg-white p-6 rounded-lg shadow-lg w-1/4 text-center flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-1xl">{taskData.total_task}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg w-1/4 text-center flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-1xl">{taskData.completed_task}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg w-1/4 text-center flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-1xl">{taskData.uncompleted_task}</p>
                    </div>

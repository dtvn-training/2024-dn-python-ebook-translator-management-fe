...
import { ContainerOutlined, LineChartOutlined } from '@ant-design/icons';
...
const sider = [
    {
        key: 1,
        label: <Link className="text-base">Dashboard</Link>,
        icon: <LineChartOutlined style={{ fontSize: '20px' }} />,
    },
    {
        key: 2,
        label: <Link className="text-base">Upload Book</Link>,
        icon: <ContainerOutlined style={{ fontSize: '20px' }} />,
    },
    {
        key: 3,
        label: <Link className="text-base">Book Management</Link>,
...
const LayoutAdminComponet = ({ children }) => {
    return (
        <Layout>
            <Header
                style={{
...
export default LayoutAdminComponet;
